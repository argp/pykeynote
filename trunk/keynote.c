/* Generated by Pyrex 0.9.4.1 on Tue Mar 27 19:09:58 2007 */
...
static PyObject *__pyx_f_7keynote_7keynote_read_asserts(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_str, __pyx_k39p, &__pyx_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 227; goto __pyx_L1;}
  __pyx_2 = __pyx_2 == 0;
  if (__pyx_2) {
  ...
  while (1) {
    ...
    __pyx_2 = __pyx_2 == 0;
    if (!__pyx_2) {
      if (PyObject_Cmp(__pyx_v_line, __pyx_k42p, &__pyx_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 237; goto __pyx_L1;}
      __pyx_2 = __pyx_2 == 0;
    }
    if (__pyx_2) {
    ...
    __pyx_2 = __pyx_2 != 0;
    if (__pyx_2) {
      if (PyObject_Cmp(__pyx_v_line, __pyx_k45p, &__pyx_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 241; goto __pyx_L1;}
      __pyx_2 = __pyx_2 != 0;
    }
    if (__pyx_2) {
  ...
  __pyx_2 = __pyx_2 != 0;
  if (__pyx_2) {
    if (PyObject_Cmp(__pyx_v_str, __pyx_k48p, &__pyx_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 248; goto __pyx_L1;}
    __pyx_2 = __pyx_2 != 0;
  }
  if (__pyx_2) {
  ...
  __pyx_2 = __pyx_2 != 0;
  if (__pyx_2) {
    if (PyObject_Cmp(__pyx_v_assertion, __pyx_k50p, &__pyx_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 251; goto __pyx_L1;}
    __pyx_2 = __pyx_2 != 0;
  }
  if (__pyx_2) {
...
static PyObject *__pyx_f_7keynote_7keynote_add_authorizer(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_principal, __pyx_k51p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 336; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (__pyx_1) {
...
static PyObject *__pyx_f_7keynote_7keynote_add_action(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_name, __pyx_k52p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 375; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (!__pyx_1) {
    if (PyObject_Cmp(__pyx_v_value, __pyx_k53p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 375; goto __pyx_L1;}
    __pyx_1 = __pyx_1 == 0;
  }
  if (__pyx_1) {
...
static PyObject *__pyx_f_7keynote_7keynote_get_string(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_str, __pyx_k54p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (!__pyx_1) {
    ...
    if (!__pyx_1) {
      ...
      __pyx_3 = PyObject_GetItem(__pyx_v_str, __pyx_2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; goto __pyx_L1;}
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      if (PyObject_Cmp(__pyx_3, __pyx_k56p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 427; goto __pyx_L1;}
      __pyx_1 = __pyx_1 != 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
    }
  }
...
static PyObject *__pyx_f_7keynote_7keynote_encode_key(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_1 = __Pyx_GetName(__pyx_b, __pyx_n_isinstance); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 468; goto __pyx_L1;}
  __pyx_2 = PyTuple_New(2); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 468; goto __pyx_L1;}
  Py_INCREF(__pyx_v_dkey);
  ...
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_1 = __Pyx_GetName(__pyx_b, __pyx_n_False); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 468; goto __pyx_L1;}
  if (PyObject_Cmp(__pyx_3, __pyx_1, &__pyx_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 468; goto __pyx_L1;}
  __pyx_4 = __pyx_4 == 0;
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  if (__pyx_4) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_b, __pyx_n_ValueError); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 469; goto __pyx_L1;}
  ...
  __pyx_3 = PyObject_GetAttr(__pyx_v_dkey, __pyx_n_algorithm); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 471; goto __pyx_L1;}
  __pyx_4 = PyInt_AsLong(__pyx_3); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 471; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_v_dc.dec_algorithm = __pyx_4;

  /* "/home/argp/projects/pykeynote/keynote.pyx":472 */
  __pyx_1 = PyObject_GetAttr(__pyx_v_dkey, __pyx_n_key); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 472; goto __pyx_L1;}
  ...
  if (__pyx_4) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 478; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 478; goto __pyx_L1;}
    __pyx_1 = PyTuple_New(1); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 478; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_1, 0, __pyx_3);
    __pyx_3 = 0;
    __pyx_3 = PyObject_CallObject(__pyx_2, __pyx_1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 478; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_1); __pyx_1 = 0;
    __Pyx_Raise(__pyx_3, 0, 0);
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  __pyx_2 = __Pyx_GetName(__pyx_b, __pyx_n_len); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 480; goto __pyx_L1;}
  __pyx_1 = PyString_FromString(__pyx_v_key); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 480; goto __pyx_L1;}
  ...
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_5 = PyInt_AsLong(__pyx_1); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 480; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_2 = PyString_FromStringAndSize(__pyx_v_key,__pyx_5); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 480; goto __pyx_L1;}
  Py_DECREF(__pyx_v_obj_key);
  __pyx_v_obj_key = __pyx_2;
  __pyx_2 = 0;
...
static PyObject *__pyx_f_7keynote_7keynote_decode_key(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_key, __pyx_k58p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 494; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (__pyx_1) {
  ...
  __pyx_1 = PyInt_AsLong(__pyx_v_keytype); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 498; goto __pyx_L1;}
  ...
  __pyx_3 = 0;
  __pyx_4 = 0;
  __pyx_3 = PyObject_CallObject(((PyObject*)__pyx_ptype_7keynote_deckey), __pyx_2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 504; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  Py_DECREF(__pyx_v_obj_key);
  __pyx_v_obj_key = __pyx_3;
  __pyx_3 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":506 */
  Py_INCREF(__pyx_v_obj_key);
  __pyx_r = __pyx_v_obj_key;
  goto __pyx_L0;
...
static PyObject *__pyx_f_7keynote_7keynote_get_licensees(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_1 = PyList_New(0); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 516; goto __pyx_L1;}
  Py_DECREF(__pyx_v_key_list);
  __pyx_v_key_list = __pyx_1;
  __pyx_1 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":518 */
  __pyx_2 = PyInt_AsLong(__pyx_v_assertid); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 518; goto __pyx_L1;}
  ...
  if (__pyx_2) {
    ...
    __pyx_1 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 522; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 522; goto __pyx_L1;}
    __pyx_4 = PyTuple_New(1); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 522; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_4, 0, __pyx_3);
    __pyx_3 = 0;
    __pyx_3 = PyObject_CallObject(__pyx_1, __pyx_4); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 522; goto __pyx_L1;}
    Py_DECREF(__pyx_1); __pyx_1 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __Pyx_Raise(__pyx_3, 0, 0);
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":524 */
  while (1) {
    __pyx_L3:;
    __pyx_2 = (__pyx_v_kl != 0);
    if (!__pyx_2) break;
    ...
    __pyx_1 = PyInt_FromLong(__pyx_v_kl->key_alg); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 525; goto __pyx_L1;}
    __pyx_4 = PyCObject_FromVoidPtr(__pyx_v_kl->key_key,0); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 526; goto __pyx_L1;}
    __pyx_3 = __Pyx_GetName(__pyx_b, __pyx_n_len); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 528; goto __pyx_L1;}
    __pyx_5 = PyString_FromString(__pyx_v_kl->key_stringkey); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 528; goto __pyx_L1;}
    __pyx_6 = PyTuple_New(1); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 528; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_6, 0, __pyx_5);
    __pyx_5 = 0;
    __pyx_5 = PyObject_CallObject(__pyx_3, __pyx_6); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 528; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    Py_DECREF(__pyx_6); __pyx_6 = 0;
    __pyx_2 = PyInt_AsLong(__pyx_5); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 528; goto __pyx_L1;}
    Py_DECREF(__pyx_5); __pyx_5 = 0;
    __pyx_3 = PyString_FromStringAndSize(__pyx_v_kl->key_stringkey,__pyx_2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 527; goto __pyx_L1;}
    __pyx_6 = PyTuple_New(3); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 525; goto __pyx_L1;}
    ...
    __pyx_4 = 0;
    __pyx_3 = 0;
    __pyx_5 = PyObject_CallObject(((PyObject*)__pyx_ptype_7keynote_deckey), __pyx_6); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 525; goto __pyx_L1;}
    Py_DECREF(__pyx_6); __pyx_6 = 0;
    Py_DECREF(__pyx_v_obj_key);
    __pyx_v_obj_key = __pyx_5;
    __pyx_5 = 0;

    /* "/home/argp/projects/pykeynote/keynote.pyx":529 */
    __pyx_1 = PyObject_GetAttr(__pyx_v_key_list, __pyx_n_append); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 529; goto __pyx_L1;}
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":532 */
...
static PyObject *__pyx_f_7keynote_7keynote_keycompare(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_2 = __Pyx_GetName(__pyx_b, __pyx_n_isinstance); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 542; goto __pyx_L1;}
  ...
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_2 = __Pyx_GetName(__pyx_b, __pyx_n_False); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 542; goto __pyx_L1;}
  if (PyObject_Cmp(__pyx_4, __pyx_2, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 542; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  if (!__pyx_1) {
    __pyx_3 = __Pyx_GetName(__pyx_b, __pyx_n_isinstance); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 542; goto __pyx_L1;}
    ...
    __pyx_2 = PyObject_CallObject(__pyx_3, __pyx_4); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 542; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __pyx_3 = __Pyx_GetName(__pyx_b, __pyx_n_False); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 543; goto __pyx_L1;}
    if (PyObject_Cmp(__pyx_2, __pyx_3, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 543; goto __pyx_L1;}
    __pyx_1 = __pyx_1 == 0;
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  }
  if (__pyx_1) {
    ...
    __pyx_4 = __Pyx_GetName(__pyx_b, __pyx_n_ValueError); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 544; goto __pyx_L1;}
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":546 */
  __pyx_2 = PyObject_GetAttr(__pyx_v_key1, __pyx_n_key); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 546; goto __pyx_L1;}
  __pyx_3 = PyObject_GetAttr(__pyx_v_key2, __pyx_n_key); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 547; goto __pyx_L1;}
  __pyx_4 = PyObject_GetAttr(__pyx_v_key1, __pyx_n_algorithm); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 547; goto __pyx_L1;}
  __pyx_1 = PyInt_AsLong(__pyx_4); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 547; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_4 = PyInt_FromLong(kn_keycompare(PyCObject_AsVoidPtr(__pyx_2),PyCObject_AsVoidPtr(__pyx_3),__pyx_1)); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 546; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  Py_DECREF(__pyx_v_retval);
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":549 */
  __pyx_1 = PyObject_IsTrue(__pyx_v_retval); if (__pyx_1 < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 549; goto __pyx_L1;}
  if (__pyx_1) {

    /* "/home/argp/projects/pykeynote/keynote.pyx":550 */
    __pyx_2 = __Pyx_GetName(__pyx_b, __pyx_n_True); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 550; goto __pyx_L1;}
    __pyx_r = __pyx_2;
    __pyx_2 = 0;
    goto __pyx_L0;
    goto __pyx_L3;
  ...
  /*else*/ {
    ...
    /* "/home/argp/projects/pykeynote/keynote.pyx":552 */
    __pyx_3 = __Pyx_GetName(__pyx_b, __pyx_n_False); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 552; goto __pyx_L1;}
    __pyx_r = __pyx_3;
    __pyx_3 = 0;
    goto __pyx_L0;
  }
...
static PyObject *__pyx_f_7keynote_7keynote_decode_hex(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_hex_str, __pyx_k60p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 564; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (__pyx_1) {

    /* "/home/argp/projects/pykeynote/keynote.pyx":565 */
    __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_ERROR_SYNTAX); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 565; goto __pyx_L1;}
    __pyx_1 = PyInt_AsLong(__pyx_2); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 565; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    ((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno = __pyx_1;

    /* "/home/argp/projects/pykeynote/keynote.pyx":566 */
    __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 566; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 566; goto __pyx_L1;}
    __pyx_4 = PyTuple_New(1); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 566; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_4, 0, __pyx_3);
    __pyx_3 = 0;
    __pyx_3 = PyObject_CallObject(__pyx_2, __pyx_4); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 566; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __Pyx_Raise(__pyx_3, 0, 0);
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":568 */
  __pyx_v_src = PyString_AsString(__pyx_v_hex_str);

  /* "/home/argp/projects/pykeynote/keynote.pyx":569 */
  __pyx_2 = PyInt_FromLong(kn_decode_hex(__pyx_v_src,(&__pyx_v_dst))); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 569; goto __pyx_L1;}
  Py_DECREF(__pyx_v_retval);
  __pyx_v_retval = __pyx_2;
  __pyx_2 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":571 */
  __pyx_4 = PyInt_FromLong(0); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 571; goto __pyx_L1;}
  if (PyObject_Cmp(__pyx_v_retval, __pyx_4, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 571; goto __pyx_L1;}
  __pyx_1 = __pyx_1 < 0;
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  if (__pyx_1) {
    ...
    __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 573; goto __pyx_L1;}
    __pyx_2 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 573; goto __pyx_L1;}
  ...
  __pyx_3 = __Pyx_GetName(__pyx_b, __pyx_n_len); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 575; goto __pyx_L1;}
  ...
  __pyx_2 = PyObject_CallObject(__pyx_3, __pyx_4); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 575; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_3 = PyInt_FromLong(2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 575; goto __pyx_L1;}
  __pyx_4 = PyNumber_Divide(__pyx_2, __pyx_3); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 575; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_1 = PyInt_AsLong(__pyx_4); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 575; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_2 = PyString_FromStringAndSize(__pyx_v_dst,__pyx_1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 575; goto __pyx_L1;}
...
static PyObject *__pyx_f_7keynote_7keynote_encode_hex(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_bin_str, __pyx_k61p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 590; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (!__pyx_1) {
    __pyx_2 = PyInt_FromLong(0); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 590; goto __pyx_L1;}
    if (PyObject_Cmp(__pyx_v_bin_len, __pyx_2, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 590; goto __pyx_L1;}
    __pyx_1 = __pyx_1 <= 0;
    Py_DECREF(__pyx_2); __pyx_2 = 0;
  }
  if (__pyx_1) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_ERROR_SYNTAX); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 591; goto __pyx_L1;}
    __pyx_1 = PyInt_AsLong(__pyx_2); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 591; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    ((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno = __pyx_1;

    /* "/home/argp/projects/pykeynote/keynote.pyx":592 */
    __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 592; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 592; goto __pyx_L1;}
    __pyx_4 = PyTuple_New(1); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 592; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_4, 0, __pyx_3);
    __pyx_3 = 0;
    __pyx_3 = PyObject_CallObject(__pyx_2, __pyx_4); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 592; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __Pyx_Raise(__pyx_3, 0, 0);
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":594 */
  __pyx_v_src = ((unsigned char (*))PyString_AsString(__pyx_v_bin_str));

  /* "/home/argp/projects/pykeynote/keynote.pyx":595 */
  __pyx_1 = PyInt_AsLong(__pyx_v_bin_len); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 595; goto __pyx_L1;}
  __pyx_2 = PyInt_FromLong(kn_encode_hex(__pyx_v_src,(&__pyx_v_dst),__pyx_1)); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 595; goto __pyx_L1;}
  Py_DECREF(__pyx_v_retval);
  __pyx_v_retval = __pyx_2;
  __pyx_2 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":597 */
  __pyx_4 = PyInt_FromLong(0); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 597; goto __pyx_L1;}
  if (PyObject_Cmp(__pyx_v_retval, __pyx_4, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 597; goto __pyx_L1;}
  __pyx_1 = __pyx_1 < 0;
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  if (__pyx_1) {
    ...
    __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 599; goto __pyx_L1;}
    __pyx_2 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 599; goto __pyx_L1;}
    __pyx_4 = PyTuple_New(1); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 599; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_4, 0, __pyx_2);
    __pyx_2 = 0;
    __pyx_2 = PyObject_CallObject(__pyx_3, __pyx_4); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 599; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __Pyx_Raise(__pyx_2, 0, 0);
    Py_DECREF(__pyx_2); __pyx_2 = 0;
  ...
  __pyx_3 = __Pyx_GetName(__pyx_b, __pyx_n_len); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 601; goto __pyx_L1;}
  __pyx_4 = PyString_FromString(__pyx_v_dst); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 601; goto __pyx_L1;}
  __pyx_2 = PyTuple_New(1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 601; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_2, 0, __pyx_4);
  __pyx_4 = 0;
  __pyx_4 = PyObject_CallObject(__pyx_3, __pyx_2); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 601; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_1 = PyInt_AsLong(__pyx_4); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 601; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_3 = PyString_FromStringAndSize(__pyx_v_dst,__pyx_1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 601; goto __pyx_L1;}
  Py_DECREF(__pyx_v_obj_str);
...
static PyObject *__pyx_f_7keynote_7keynote_encode_base64(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_bin_str, __pyx_k62p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 616; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (!__pyx_1) {
    __pyx_2 = PyInt_FromLong(0); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 616; goto __pyx_L1;}
    if (PyObject_Cmp(__pyx_v_bin_len, __pyx_2, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 616; goto __pyx_L1;}
    __pyx_1 = __pyx_1 <= 0;
    Py_DECREF(__pyx_2); __pyx_2 = 0;
  }
  if (__pyx_1) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_ERROR_SYNTAX); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 617; goto __pyx_L1;}
    __pyx_1 = PyInt_AsLong(__pyx_2); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 617; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    ((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno = __pyx_1;

    /* "/home/argp/projects/pykeynote/keynote.pyx":618 */
    __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 618; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 618; goto __pyx_L1;}
    __pyx_4 = PyTuple_New(1); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 618; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_4, 0, __pyx_3);
    __pyx_3 = 0;
    __pyx_3 = PyObject_CallObject(__pyx_2, __pyx_4); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 618; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __Pyx_Raise(__pyx_3, 0, 0);
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  __pyx_2 = PyInt_FromLong(2); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 621; goto __pyx_L1;}
  __pyx_4 = PyNumber_Multiply(__pyx_v_bin_len, __pyx_2); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 621; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_3 = PyInt_FromLong((sizeof(char ))); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 621; goto __pyx_L1;}
  __pyx_2 = PyNumber_Multiply(__pyx_4, __pyx_3); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 621; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_1 = PyInt_AsLong(__pyx_2); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 621; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_v_dst = ((char (*))malloc(__pyx_1));

  /* "/home/argp/projects/pykeynote/keynote.pyx":622 */
  __pyx_5 = PyInt_AsUnsignedLongMask(__pyx_v_bin_len); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 622; goto __pyx_L1;}
  __pyx_4 = PyInt_FromLong(2); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 622; goto __pyx_L1;}
  __pyx_3 = PyNumber_Multiply(__pyx_v_bin_len, __pyx_4); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 622; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_6 = PyInt_AsUnsignedLongMask(__pyx_3); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 622; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_2 = PyInt_FromLong(kn_encode_base64(__pyx_v_src,__pyx_5,__pyx_v_dst,__pyx_6)); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 622; goto __pyx_L1;}
  Py_DECREF(__pyx_v_retval);
  __pyx_v_retval = __pyx_2;
  __pyx_2 = 0;
  ...
  if (PyObject_Cmp(__pyx_v_retval, __pyx_4, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 624; goto __pyx_L1;}
  __pyx_1 = __pyx_1 < 0;
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  if (__pyx_1) {
    ...
    __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 626; goto __pyx_L1;}
    __pyx_2 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 626; goto __pyx_L1;}
    __pyx_4 = PyTuple_New(1); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 626; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_4, 0, __pyx_2);
    __pyx_2 = 0;
    __pyx_2 = PyObject_CallObject(__pyx_3, __pyx_4); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 626; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __Pyx_Raise(__pyx_2, 0, 0);
    Py_DECREF(__pyx_2); __pyx_2 = 0;
  ...
  __pyx_3 = __Pyx_GetName(__pyx_b, __pyx_n_len); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 628; goto __pyx_L1;}
  __pyx_4 = PyString_FromString(__pyx_v_dst); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 628; goto __pyx_L1;}
  __pyx_2 = PyTuple_New(1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 628; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_2, 0, __pyx_4);
  __pyx_4 = 0;
  __pyx_4 = PyObject_CallObject(__pyx_3, __pyx_2); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 628; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_1 = PyInt_AsLong(__pyx_4); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 628; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_3 = PyString_FromStringAndSize(__pyx_v_dst,__pyx_1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 628; goto __pyx_L1;}
  Py_DECREF(__pyx_v_obj_str);
  __pyx_v_obj_str = __pyx_3;
  __pyx_3 = 0;
...
static PyObject *__pyx_f_7keynote_7keynote_decode_base64(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_b64_str, __pyx_k63p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 642; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (__pyx_1) {

    /* "/home/argp/projects/pykeynote/keynote.pyx":643 */
    __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_ERROR_SYNTAX); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 643; goto __pyx_L1;}
    ...
    __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 644; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 644; goto __pyx_L1;}
    __pyx_4 = PyTuple_New(1); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 644; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_4, 0, __pyx_3);
    __pyx_3 = 0;
    __pyx_3 = PyObject_CallObject(__pyx_2, __pyx_4); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 644; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __Pyx_Raise(__pyx_3, 0, 0);
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  __pyx_2 = PyInt_FromLong(3); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 646; goto __pyx_L1;}
  __pyx_4 = __Pyx_GetName(__pyx_b, __pyx_n_len); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 646; goto __pyx_L1;}
  ...
  __pyx_5 = PyObject_CallObject(__pyx_4, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 646; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_4 = PyInt_FromLong(4); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 646; goto __pyx_L1;}
  __pyx_3 = PyNumber_Divide(__pyx_5, __pyx_4); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 646; goto __pyx_L1;}
  Py_DECREF(__pyx_5); __pyx_5 = 0;
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_5 = PyNumber_Multiply(__pyx_2, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 646; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  __pyx_4 = PyInt_FromLong((sizeof(unsigned char ))); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 648; goto __pyx_L1;}
  __pyx_2 = PyNumber_Multiply(__pyx_v_blen, __pyx_4); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 648; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  ...
  __pyx_6 = PyString_AsString(__pyx_v_b64_str); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 649; goto __pyx_L1;}
  __pyx_7 = PyInt_AsUnsignedLongMask(__pyx_v_blen); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 649; goto __pyx_L1;}
  __pyx_3 = PyInt_FromLong(kn_decode_base64(__pyx_6,__pyx_v_dst,__pyx_7)); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 649; goto __pyx_L1;}
  Py_DECREF(__pyx_v_retval);
  __pyx_v_retval = __pyx_3;
  __pyx_3 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":651 */
  __pyx_5 = PyInt_FromLong(0); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 651; goto __pyx_L1;}
  if (PyObject_Cmp(__pyx_v_retval, __pyx_5, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 651; goto __pyx_L1;}
  __pyx_1 = __pyx_1 < 0;
  Py_DECREF(__pyx_5); __pyx_5 = 0;
  if (__pyx_1) {
    ...
    __pyx_4 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 653; goto __pyx_L1;}
    __pyx_2 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 653; goto __pyx_L1;}
    __pyx_3 = PyTuple_New(1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 653; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_3, 0, __pyx_2);
    __pyx_2 = 0;
    __pyx_5 = PyObject_CallObject(__pyx_4, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 653; goto __pyx_L1;}
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  __pyx_1 = PyInt_AsLong(__pyx_v_blen); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 655; goto __pyx_L1;}
  __pyx_2 = PyString_FromStringAndSize(((char (*))__pyx_v_dst),__pyx_1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 655; goto __pyx_L1;}
  Py_DECREF(__pyx_v_obj_str);
  __pyx_v_obj_str = __pyx_2;
  __pyx_2 = 0;
...
static PyObject *__pyx_f_7keynote_7keynote_get_failed(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":668 */
  __pyx_1 = PyInt_AsLong(__pyx_v_type); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 668; goto __pyx_L1;}
  __pyx_2 = PyInt_AsLong(__pyx_v_seq); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 668; goto __pyx_L1;}
  __pyx_3 = PyInt_FromLong(kn_get_failed(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->session,__pyx_1,__pyx_2)); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 668; goto __pyx_L1;}
  Py_DECREF(__pyx_v_retval);
  __pyx_v_retval = __pyx_3;
  __pyx_3 = 0;
...
static PyObject *__pyx_f_7keynote_7keynote_do_query(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":689 */
  ...
  if (__pyx_1) {
    ...
    /* "/home/argp/projects/pykeynote/keynote.pyx":692 */
    ...
    /* "/home/argp/projects/pykeynote/keynote.pyx":695 */
    ...
    __pyx_2 = PyObject_GetIter(__pyx_v_slist); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 698; goto __pyx_L1;}
    for (;;) {
      __pyx_L4:;
      __pyx_3 = PyIter_Next(__pyx_2);
      if (!__pyx_3) {
        if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 698; goto __pyx_L1;}
        break;
      }
      ...
      if (__pyx_1) {
        ...
        __pyx_4 = PyString_AsString(__pyx_v_el); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 700; goto __pyx_L1;}
        (__pyx_v_s[0]) = __pyx_4;
      ...
      /*else*/ {
        ...
        /* "/home/argp/projects/pykeynote/keynote.pyx":703 */
        __pyx_3 = __Pyx_GetName(__pyx_b, __pyx_n_ValueError); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 703; goto __pyx_L1;}
  ...
  /*else*/ {
    ...
    /* "/home/argp/projects/pykeynote/keynote.pyx":706 */
    __pyx_3 = __Pyx_GetName(__pyx_b, __pyx_n_ValueError); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 706; goto __pyx_L1;}
  ...
  __pyx_2 = PyObject_GetIter(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->callbacks); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 709; goto __pyx_L1;}
  for (;;) {
    __pyx_L7:;
    __pyx_3 = PyIter_Next(__pyx_2);
    if (!__pyx_3) {
      if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 709; goto __pyx_L1;}
      break;
    }
    Py_DECREF(__pyx_v_el);
    __pyx_v_el = __pyx_3;
    ...
    __pyx_3 = __Pyx_UnpackItem(__pyx_v_el, 0); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 710; goto __pyx_L1;}
    Py_DECREF(__pyx_v_name);
    __pyx_v_name = __pyx_3;
    __pyx_3 = 0;
    __pyx_5 = __Pyx_UnpackItem(__pyx_v_el, 1); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 710; goto __pyx_L1;}
    Py_DECREF(__pyx_v_func);
    __pyx_v_func = __pyx_5;
    __pyx_5 = 0;
    __pyx_6 = __Pyx_UnpackItem(__pyx_v_el, 2); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 710; goto __pyx_L1;}
    Py_DECREF(__pyx_v_flags);
    __pyx_v_flags = __pyx_6;
    __pyx_6 = 0;
    if (__Pyx_EndUnpack(__pyx_v_el, 3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 710; goto __pyx_L1;}
    ...
    __pyx_5 = PyObject_CallObject(__pyx_v_func, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 711; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    ...
    __pyx_6 = __Pyx_GetName(__pyx_m, __pyx_n_ENVIRONMENT_FLAG_FUNC); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 712; goto __pyx_L1;}
    __pyx_3 = PyNumber_Invert(__pyx_6); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 712; goto __pyx_L1;}
    Py_DECREF(__pyx_6); __pyx_6 = 0;
    __pyx_5 = PyNumber_And(__pyx_v_flags, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 712; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    Py_DECREF(__pyx_v_flags);
    ...
    __pyx_6 = PyObject_GetAttr(__pyx_v_self, __pyx_n_add_action); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 713; goto __pyx_L1;}
    __pyx_3 = PyTuple_New(3); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 713; goto __pyx_L1;}
    Py_INCREF(__pyx_v_name);
    PyTuple_SET_ITEM(__pyx_3, 0, __pyx_v_name);
    ...
    __pyx_5 = PyObject_CallObject(__pyx_6, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 713; goto __pyx_L1;}
    Py_DECREF(__pyx_6); __pyx_6 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    Py_DECREF(__pyx_5); __pyx_5 = 0;
  }
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":715 */
  __pyx_6 = PyInt_FromLong(kn_do_query(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->session,__pyx_v_v,__pyx_v_size)); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 715; goto __pyx_L1;}
  Py_DECREF(__pyx_v_retval);
  ...
  __pyx_3 = PyObject_GetIter(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->callbacks); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 718; goto __pyx_L1;}
  for (;;) {
    __pyx_L9:;
    __pyx_5 = PyIter_Next(__pyx_3);
    if (!__pyx_5) {
      if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 718; goto __pyx_L1;}
      break;
    }
    Py_DECREF(__pyx_v_el);
    __pyx_v_el = __pyx_5;
    ...
    __pyx_2 = __Pyx_UnpackItem(__pyx_v_el, 0); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 719; goto __pyx_L1;}
    Py_DECREF(__pyx_v_name);
    __pyx_v_name = __pyx_2;
    __pyx_2 = 0;
    __pyx_6 = __Pyx_UnpackItem(__pyx_v_el, 1); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 719; goto __pyx_L1;}
    Py_DECREF(__pyx_v_func);
    __pyx_v_func = __pyx_6;
    __pyx_6 = 0;
    __pyx_5 = __Pyx_UnpackItem(__pyx_v_el, 2); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 719; goto __pyx_L1;}
    Py_DECREF(__pyx_v_flags);
    __pyx_v_flags = __pyx_5;
    __pyx_5 = 0;
    if (__Pyx_EndUnpack(__pyx_v_el, 3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 719; goto __pyx_L1;}

    /* "/home/argp/projects/pykeynote/keynote.pyx":720 */
    /*try:*/ {

      /* "/home/argp/projects/pykeynote/keynote.pyx":721 */
      __pyx_2 = PyObject_GetAttr(__pyx_v_self, __pyx_n_remove_action); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 721; goto __pyx_L11;}
      __pyx_6 = PyTuple_New(1); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 721; goto __pyx_L11;}
      Py_INCREF(__pyx_v_name);
      PyTuple_SET_ITEM(__pyx_6, 0, __pyx_v_name);
      __pyx_5 = PyObject_CallObject(__pyx_2, __pyx_6); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 721; goto __pyx_L11;}
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      Py_DECREF(__pyx_6); __pyx_6 = 0;
      Py_DECREF(__pyx_5); __pyx_5 = 0;
    }
    ...
    /*except:*/ {
      ...
      __pyx_2 = __Pyx_GetExcValue(); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 722; goto __pyx_L1;}
      Py_DECREF(__pyx_2); __pyx_2 = 0;
  ...
  __pyx_6 = PyInt_FromLong(0); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 725; goto __pyx_L1;}
  if (PyObject_Cmp(__pyx_v_retval, __pyx_6, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 725; goto __pyx_L1;}
  __pyx_1 = __pyx_1 < 0;
  Py_DECREF(__pyx_6); __pyx_6 = 0;
  if (__pyx_1) {
    ...
    __pyx_5 = __Pyx_GetName(__pyx_m, __pyx_n_keynote_error); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 727; goto __pyx_L1;}
    __pyx_2 = PyInt_FromLong(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->keynote_errno); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 727; goto __pyx_L1;}
    __pyx_3 = PyTuple_New(1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 727; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_3, 0, __pyx_2);
    __pyx_2 = 0;
    __pyx_6 = PyObject_CallObject(__pyx_5, __pyx_3); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 727; goto __pyx_L1;}
    Py_DECREF(__pyx_5); __pyx_5 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":729 */
  Py_INCREF(__pyx_v_retval);
  __pyx_r = __pyx_v_retval;
  goto __pyx_L0;
...
static PyObject *__pyx_f_7keynote_7keynote___callback_cleanup(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_1 = __Pyx_GetName(__pyx_b, __pyx_n_len); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 732; goto __pyx_L1;}
  ...
  if (PyObject_Cmp(__pyx_3, __pyx_1, &__pyx_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 732; goto __pyx_L1;}
  __pyx_4 = __pyx_4 > 0;
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  if (__pyx_4) {
    ...
    __pyx_2 = PyObject_GetIter(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->callbacks); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 733; goto __pyx_L1;}
    for (;;) {
      __pyx_L3:;
      __pyx_3 = PyIter_Next(__pyx_2);
      if (!__pyx_3) {
        if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 733; goto __pyx_L1;}
        break;
      }
      Py_DECREF(__pyx_v_el);
      __pyx_v_el = __pyx_3;
      ...
      __pyx_1 = __Pyx_UnpackItem(__pyx_v_el, 0); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 734; goto __pyx_L1;}
      Py_DECREF(__pyx_v_name);
      __pyx_v_name = __pyx_1;
      __pyx_1 = 0;
      __pyx_3 = __Pyx_UnpackItem(__pyx_v_el, 1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 734; goto __pyx_L1;}
      Py_DECREF(__pyx_v_func);
      __pyx_v_func = __pyx_3;
      __pyx_3 = 0;
      __pyx_5 = __Pyx_UnpackItem(__pyx_v_el, 2); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 734; goto __pyx_L1;}
      Py_DECREF(__pyx_v_flags);
      __pyx_v_flags = __pyx_5;
      __pyx_5 = 0;
      if (__Pyx_EndUnpack(__pyx_v_el, 3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 734; goto __pyx_L1;}

      /* "/home/argp/projects/pykeynote/keynote.pyx":735 */
      __pyx_1 = __Pyx_GetName(__pyx_m, __pyx_n_KEYNOTE_CALLBACK_CLEANUP); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 735; goto __pyx_L1;}
      __pyx_3 = PyTuple_New(1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 735; goto __pyx_L1;}
      PyTuple_SET_ITEM(__pyx_3, 0, __pyx_1);
      __pyx_1 = 0;
      __pyx_5 = PyObject_CallObject(__pyx_v_func, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 735; goto __pyx_L1;}
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      Py_DECREF(__pyx_5); __pyx_5 = 0;

      /* "/home/argp/projects/pykeynote/keynote.pyx":736 */
      __pyx_1 = PyObject_GetAttr(((struct __pyx_obj_7keynote_keynote *)__pyx_v_self)->callbacks, __pyx_n_remove); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 736; goto __pyx_L1;}
      ...
      __pyx_5 = PyObject_CallObject(__pyx_1, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 736; goto __pyx_L1;}
      Py_DECREF(__pyx_1); __pyx_1 = 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      Py_DECREF(__pyx_5); __pyx_5 = 0;
    }
...
static void __pyx_f_7keynote_7keynote___dealloc__(PyObject *__pyx_v_self) {
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":741 */
...
static int __pyx_f_7keynote_6deckey___new__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_1 = PyInt_AsLong(__pyx_v_algorithm); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 763; goto __pyx_L1;}
  ...
  __pyx_1 = PyInt_AsLong(__pyx_v_keytype); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 765; goto __pyx_L1;}
  ((struct __pyx_obj_7keynote_deckey *)__pyx_v_self)->key_type = __pyx_1;

  /* "/home/argp/projects/pykeynote/keynote.pyx":767 */
  if (PyObject_Cmp(__pyx_v_stringkey, Py_None, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 767; goto __pyx_L1;}
  __pyx_1 = __pyx_1 != 0;
  if (__pyx_1) {
  ...
  /*else*/ {
    ...
    /* "/home/argp/projects/pykeynote/keynote.pyx":770 */
...
static PyObject *__pyx_f_7keynote_6deckey_9algorithm___get__(PyObject *__pyx_v_self) {
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":775 */
  __pyx_1 = PyInt_FromLong(((struct __pyx_obj_7keynote_deckey *)__pyx_v_self)->dc->dec_algorithm); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 775; goto __pyx_L1;}
  __pyx_r = __pyx_1;
  __pyx_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_7keynote_6deckey_3key___get__(PyObject *__pyx_v_self) {
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":780 */
  __pyx_1 = PyCObject_FromVoidPtr(((struct __pyx_obj_7keynote_deckey *)__pyx_v_self)->dc->dec_key,0); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 780; goto __pyx_L1;}
  __pyx_r = __pyx_1;
  __pyx_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_7keynote_6deckey_7keytype___get__(PyObject *__pyx_v_self) {
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":785 */
  __pyx_1 = PyInt_FromLong(((struct __pyx_obj_7keynote_deckey *)__pyx_v_self)->key_type); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 785; goto __pyx_L1;}
  __pyx_r = __pyx_1;
  __pyx_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_7keynote_6deckey_9stringkey___get__(PyObject *__pyx_v_self) {
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":790 */
  ...
  /*else*/ {
    ...
    /* "/home/argp/projects/pykeynote/keynote.pyx":793 */
    __pyx_2 = __Pyx_GetName(__pyx_b, __pyx_n_len); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 794; goto __pyx_L1;}
    __pyx_3 = PyString_FromString(((struct __pyx_obj_7keynote_deckey *)__pyx_v_self)->key_stringkey); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 794; goto __pyx_L1;}
    __pyx_4 = PyTuple_New(1); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 794; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_4, 0, __pyx_3);
    __pyx_3 = 0;
    __pyx_3 = PyObject_CallObject(__pyx_2, __pyx_4); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 794; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __pyx_1 = PyInt_AsLong(__pyx_3); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 794; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    __pyx_2 = PyString_FromStringAndSize(((struct __pyx_obj_7keynote_deckey *)__pyx_v_self)->key_stringkey,__pyx_1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 793; goto __pyx_L1;}
    __pyx_r = __pyx_2;
    __pyx_2 = 0;
    goto __pyx_L0;
  }
...
static void __pyx_f_7keynote_6deckey___dealloc__(PyObject *__pyx_v_self) {
  ...
  /* "/home/argp/projects/pykeynote/keynote.pyx":797 */
...
static PyObject *__pyx_f_7keynote_13keynote_error___init__(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_SetAttr(__pyx_v_self, __pyx_n_knerrno, __pyx_v_knerrno) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 809; goto __pyx_L1;}
...
static PyObject *__pyx_f_7keynote_13keynote_error___str__(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_ERROR_MEMORY); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 812; goto __pyx_L1;}
  ...
  __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_ERROR_SYNTAX); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 814; goto __pyx_L1;}
  ...
  __pyx_1 = PyObject_GetAttr(__pyx_v_self, __pyx_n_knerrno); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 816; goto __pyx_L1;}
  __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_ERROR_NOTFOUND); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 816; goto __pyx_L1;}
  if (PyObject_Cmp(__pyx_1, __pyx_2, &__pyx_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 816; goto __pyx_L1;}
  __pyx_3 = __pyx_3 == 0;
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  if (__pyx_3) {
  ...
  /*else*/ {
    ...
    /* "/home/argp/projects/pykeynote/keynote.pyx":819 */
    __pyx_1 = PyObject_GetAttr(__pyx_v_self, __pyx_n_knerrno); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 819; goto __pyx_L1;}
    __pyx_2 = PyNumber_Remainder(__pyx_k70p, __pyx_1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 819; goto __pyx_L1;}
    Py_DECREF(__pyx_1); __pyx_1 = 0;
    __pyx_r = __pyx_2;
    __pyx_2 = 0;
    goto __pyx_L0;
...
PyMODINIT_FUNC initkeynote(void) {
  ...
  if (PyType_Ready(&__pyx_type_7keynote_deckey) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 743; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "deckey", (PyObject *)&__pyx_type_7keynote_deckey) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 743; goto __pyx_L1;}
  ...
  __pyx_k29 = __pyx_6;
  __pyx_6 = 0;
  __pyx_7 = __Pyx_GetName(__pyx_m, __pyx_n_KEYNOTE_PUBLIC_KEY); if (!__pyx_7) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 455; goto __pyx_L1;}
  __pyx_k30 = __pyx_7;
  __pyx_7 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":484 */
  __pyx_8 = __Pyx_GetName(__pyx_m, __pyx_n_KEYNOTE_PUBLIC_KEY); if (!__pyx_8) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 484; goto __pyx_L1;}
  __pyx_k31 = __pyx_8;
  __pyx_8 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":659 */
  __pyx_9 = __Pyx_GetName(__pyx_m, __pyx_n_KEYNOTE_ERROR_ANY); if (!__pyx_9) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 659; goto __pyx_L1;}
  __pyx_k32 = __pyx_9;
  __pyx_9 = 0;
  ...
  Py_INCREF(Py_None);
  __pyx_k34 = Py_None;
  __pyx_11 = __Pyx_GetName(__pyx_m, __pyx_n_KEYNOTE_PUBLIC_KEY); if (!__pyx_11) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 761; goto __pyx_L1;}
  __pyx_k35 = __pyx_11;
  __pyx_11 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":800 */
  __pyx_12 = PyDict_New(); if (!__pyx_12) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
  __pyx_13 = __Pyx_GetName(__pyx_b, __pyx_n_RuntimeError); if (!__pyx_13) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
  __pyx_14 = PyTuple_New(1); if (!__pyx_14) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_14, 0, __pyx_13);
  __pyx_13 = 0;
  if (PyDict_SetItemString(__pyx_12, "__doc__", __pyx_k37p) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
  __pyx_13 = __Pyx_CreateClass(__pyx_14, __pyx_12, __pyx_n_keynote_error, "keynote"); if (!__pyx_13) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
  Py_DECREF(__pyx_14); __pyx_14 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":808 */
  __pyx_14 = PyCFunction_New(&__pyx_mdef_7keynote_13keynote_error___init__, 0); if (!__pyx_14) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 808; goto __pyx_L1;}
  __pyx_15 = PyMethod_New(__pyx_14, 0, __pyx_13); if (!__pyx_15) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 808; goto __pyx_L1;}
  Py_DECREF(__pyx_14); __pyx_14 = 0;
  if (PyObject_SetAttr(__pyx_13, __pyx_n___init__, __pyx_15) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 808; goto __pyx_L1;}
  Py_DECREF(__pyx_15); __pyx_15 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":811 */
  __pyx_14 = PyCFunction_New(&__pyx_mdef_7keynote_13keynote_error___str__, 0); if (!__pyx_14) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 811; goto __pyx_L1;}
  __pyx_15 = PyMethod_New(__pyx_14, 0, __pyx_13); if (!__pyx_15) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 811; goto __pyx_L1;}
  Py_DECREF(__pyx_14); __pyx_14 = 0;
  if (PyObject_SetAttr(__pyx_13, __pyx_n___str__, __pyx_15) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 811; goto __pyx_L1;}
  Py_DECREF(__pyx_15); __pyx_15 = 0;
  if (PyObject_SetAttr(__pyx_m, __pyx_n_keynote_error, __pyx_13) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
