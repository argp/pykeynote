/* Generated by Pyrex 0.9.4.1 on Sun Jul  8 15:54:37 2007 */
...
static char (__pyx_k58[]) = "deckey objects expected";
...
static PyObject *__pyx_f_7keynote_7keynote_keycompare(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (__pyx_1) {
    ...
    __Pyx_Raise(__pyx_4, __pyx_k58p, 0);
    Py_DECREF(__pyx_4); __pyx_4 = 0;
...
static PyObject *__pyx_f_7keynote_7keynote_decode_hex(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_hex_str, __pyx_k59p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 564; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (__pyx_1) {
...
static PyObject *__pyx_f_7keynote_7keynote_encode_hex(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_bin_str, __pyx_k60p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 590; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (!__pyx_1) {
...
static PyObject *__pyx_f_7keynote_7keynote_encode_base64(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_bin_str, __pyx_k61p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 616; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (!__pyx_1) {
...
static PyObject *__pyx_f_7keynote_7keynote_decode_base64(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (PyObject_Cmp(__pyx_v_b64_str, __pyx_k62p, &__pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 642; goto __pyx_L1;}
  __pyx_1 = __pyx_1 == 0;
  if (__pyx_1) {
...
static char (__pyx_k63[]) = "empty list";
static char (__pyx_k64[]) = "input listmust contain strings";
static char (__pyx_k65[]) = "input not a list";
...
static char (__pyx_k66[]) = "memory allocation or usage error";
static char (__pyx_k67[]) = "syntactic or logical error";
static char (__pyx_k68[]) = "nonexistent structure or entry";
static char (__pyx_k69[]) = "unknown error (%s)";
...
static PyObject *__pyx_f_7keynote_13keynote_error___str__(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /*else*/ {
    ...
    __pyx_2 = PyNumber_Remainder(__pyx_k69p, __pyx_1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 819; goto __pyx_L1;}
    Py_DECREF(__pyx_1); __pyx_1 = 0;
    __pyx_r = __pyx_2;
    __pyx_2 = 0;
    goto __pyx_L0;
...
PyMODINIT_FUNC initkeynote(void) {
  ...
  __pyx_8 = __Pyx_GetName(__pyx_m, __pyx_n_KEYNOTE_ERROR_ANY); if (!__pyx_8) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 659; goto __pyx_L1;}
  __pyx_k31 = __pyx_8;
  __pyx_8 = 0;
  __pyx_9 = PyInt_FromLong(0); if (!__pyx_9) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 659; goto __pyx_L1;}
  __pyx_k32 = __pyx_9;
  __pyx_9 = 0;
  ...
  Py_INCREF(Py_None);
  __pyx_k33 = Py_None;
  __pyx_10 = __Pyx_GetName(__pyx_m, __pyx_n_KEYNOTE_PUBLIC_KEY); if (!__pyx_10) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 761; goto __pyx_L1;}
  __pyx_k34 = __pyx_10;
  __pyx_10 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":800 */
  __pyx_11 = PyDict_New(); if (!__pyx_11) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
  __pyx_12 = __Pyx_GetName(__pyx_b, __pyx_n_RuntimeError); if (!__pyx_12) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
  __pyx_13 = PyTuple_New(1); if (!__pyx_13) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_13, 0, __pyx_12);
  __pyx_12 = 0;
  if (PyDict_SetItemString(__pyx_11, "__doc__", __pyx_k36p) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
  __pyx_12 = __Pyx_CreateClass(__pyx_13, __pyx_11, __pyx_n_keynote_error, "keynote"); if (!__pyx_12) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
  Py_DECREF(__pyx_13); __pyx_13 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":808 */
  __pyx_13 = PyCFunction_New(&__pyx_mdef_7keynote_13keynote_error___init__, 0); if (!__pyx_13) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 808; goto __pyx_L1;}
  __pyx_14 = PyMethod_New(__pyx_13, 0, __pyx_12); if (!__pyx_14) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 808; goto __pyx_L1;}
  Py_DECREF(__pyx_13); __pyx_13 = 0;
  if (PyObject_SetAttr(__pyx_12, __pyx_n___init__, __pyx_14) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 808; goto __pyx_L1;}
  Py_DECREF(__pyx_14); __pyx_14 = 0;

  /* "/home/argp/projects/pykeynote/keynote.pyx":811 */
  __pyx_13 = PyCFunction_New(&__pyx_mdef_7keynote_13keynote_error___str__, 0); if (!__pyx_13) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 811; goto __pyx_L1;}
  __pyx_14 = PyMethod_New(__pyx_13, 0, __pyx_12); if (!__pyx_14) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 811; goto __pyx_L1;}
  Py_DECREF(__pyx_13); __pyx_13 = 0;
  if (PyObject_SetAttr(__pyx_12, __pyx_n___str__, __pyx_14) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 811; goto __pyx_L1;}
  Py_DECREF(__pyx_14); __pyx_14 = 0;
  if (PyObject_SetAttr(__pyx_m, __pyx_n_keynote_error, __pyx_12) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 800; goto __pyx_L1;}
